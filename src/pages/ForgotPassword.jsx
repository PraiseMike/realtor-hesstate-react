        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p>
                <Link to="/sign-in" className='text-blue-600 hover:text-blue-800 transition duration-150'>Sign in instead</Link>
              </p>
            </div>
           ...
           ease-in-out hover:shadow-lg active:bg-blue-800' type='submit'>Send Reset Password</button>
